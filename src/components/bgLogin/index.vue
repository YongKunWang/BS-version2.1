...
.slide-box {
  ...
  li {
    ...
    &:nth-child(1) {
      background-image: url('../../assets/imgs/login/bg-4.jpg');
    }

    &:nth-child(2) {
      background-image: url('../../assets/imgs/login/bg-5.jpg');
      background-size: 100% 100%;
    ...
    &:nth-child(3) {
      background-image: url('../../assets/imgs/login/bg-2.jpg');
      background-size: 100% 100%;
    ...
    &:nth-child(4) {
      background-image: url('../../assets/imgs/login/bg-1.png');
      background-size: 100% 100%;
      animation-delay: 36s;
    }
  }
